...
extends atg.servlet.jsp.DynamoJspPageServlet implements atg.servlet.pagecompile.AttrCompiledServlet {
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            __fileData.writeBytes (1972, 41, out);
            out.print(request.encodeURL ("configure-server-services.jhtml", true, true, false, true));
            /*** lines: 73-73 */
            __fileData.writeBytes (2044, 17, out);
            /*** lines: 73-73 */
            __fileData.writeBytes (2088, 16, out);
            request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
            /*** lines: 73-82 */
            __fileData.writeBytes (2125, 159, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            __fileData.writeBytes (2365, 41, out);
            out.print(request.encodeURL ("configure-server-services.jhtml", true, true, false, true));
            /*** lines: 85-85 */
            __fileData.writeBytes (2437, 17, out);
            /*** lines: 85-85 */
            __fileData.writeBytes (2481, 16, out);
            /*** lines: 85-89 */
            __fileData.writeBytes (2518, 1, out);
            if (!request.serviceParameter("element", request, response, PageCompileServlet.getEscapeHTMLTagConverter(), null)) {
            }
            request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
            /*** lines: 89-92 */
            __fileData.writeBytes (2554, 59, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 56-58 */
            __fileData.writeBytes (1404, 20, out);
            try {
              request.pushFrame();
            ...
            /*** lines: 93-96 */
            __fileData.writeBytes (2639, 23, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            DropletImports _imports = (DropletImports) request.getObjectParameter(ServletUtil.IMPORTS_NAME);
            /*** lines: 140-147 */
            __fileData.writeBytes (3971, 271, out);
            {
            ...
            /*** lines: 147-151 */
            __fileData.writeBytes (4296, 82, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            request.setParameterDelimiter(ServletUtil.getParamDelimiter(request));
            /*** lines: 171-171 */
            __fileData.writeBytes (4829, 262, out);
            out.print(request.encodeURL ("config-cms-path.jhtml", true, true, false, true));
            request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
            /*** lines: 171-185 */
            __fileData.writeBytes (5112, 63, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
      ...
      ByteFileData __fileData = null;
      {
        ...
        try {
          ...
          try {
            ...
            request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
            /*** lines: 108-121 */
            __fileData.writeBytes (2912, 221, out);
            {
            ...
            /*** lines: 121-123 */
            __fileData.writeBytes (3186, 10, out);
            try {
              request.pushFrame();
            ...
            request.setParameterDelimiter(ServletUtil.getParamDelimiter(request));
            /*** lines: 186-186 */
            __fileData.writeBytes (5195, 164, out);
            out.print(request.encodeURL ("../../docs/", true, true, false, true));
            request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
            /*** lines: 186-196 */
            __fileData.writeBytes (5370, 68, out);
          }
          finally {
            if (_saveBaseDir != null) request.setBaseDirectory(_saveBaseDir);
          }
  ...
  NSAPIConfigure.winReset();
        ...
        request.setParameterDelimiter(ServletUtil.getParamDelimiter(request));
        /*** lines: 20-20 */
        __fileData.writeBytes (656, 174, out);
        out.print(request.encodeURL ("/", true, true, false, true));
        request.setParameterDelimiter(DynamoHttpServletRequest.DEFAULT_PARAMETER_DELIMITER);
        /*** lines: 20-44 */
        __fileData.writeBytes (831, 280, out);
        {
          Object _t = DropletDescriptor.getPropertyValue(request, response, "/atg/dynamo/admin/Configure.thisHostname", true, PageCompileServlet.getEscapeHTMLTagConverter(), null);
          if (_t == null) {
          }
        ...
        /*** lines: 44-53 */
        __fileData.writeBytes (1164, 124, out);
        try {
          request.pushFrame();
        ...
        /*** lines: 197-201 */
        __fileData.writeBytes (5458, 18, out);
/* @version $Id: //product/DAS/version/11.1/release/DAS/admin/atg/dynamo/admin/en/configure-server.jhtml#1 $$Change: 875535 $ */        /*** lines: 201-201 */
        __fileData.writeBytes (5617, 1, out);
      } catch (Exception e) {
