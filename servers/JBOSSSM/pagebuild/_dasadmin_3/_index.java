...
response.sendLocalRedirect(response.encodeURL("atg/dynamo/admin/" +
    result + "/"), request);
        ...
        /*** lines: 25-26 */
        __fileData.writeBytes (637, 1, out);
/* @version $Id: //product/DAS/version/11.1/release/DAS/admin/index.jhtml#1 $$Change: 875535 $*/        /*** lines: 26-27 */
        __fileData.writeBytes (747, 2, out);
      } catch (Exception e) {
